...
%Declaración de variables simbólicas (1 Rotacional, 2 Prismáticas)
...
R(:,:,1)= sym([cos(th1), -sin(th1), 0;
               sin(th1),  cos(th1), 0;
                      0,         0, 1]);

%Articulación 2 (Prismática, Rotación en X de -90 grados)
%Posición de la articulación 2 respecto a 1
P(:,:,2)= [0; 0; L2];
%Matriz de rotación de la junta 2 respecto a 1... -90 en X
R(:,:,2)= [1, 0,  0;
           0, 0,  1;
           0,-1,  0];
...
%Calculamos el jacobiano lineal de forma diferencial (3 variables)
